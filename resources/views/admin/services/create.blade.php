            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Add New Service Form</div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('en_title') is-invalid @enderror" id="en_title" name="en_title" placeholder="English Service Title">
                                        @error('en_title')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('icon') is-invalid @enderror" id="icon" name="icon" placeholder="fas fa-allergies">
                                        @error('icon')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
